...
export default function Home() {
  return (
    <div className="container w-full min-h-screen text-gray-500 flex justify-center items-center">
      <div className="wrapper flex flex-col items-center justify-center min-h-screen h-full w-960 gap-6 md:gap-10 px-4 md:px-0 overflow-x-hidden">
        ...
        <div className="flex flex-wrap flex-row justify-start items-center gap-24">
      ...
      <div className="w-full flex flex-wrap justify-between gap-16">
        <div className="text-gray-500 w-48 flex justify-center items-center">
          ...
          <div className="flex flex-col flex-grow-0 flex-shrink-0 flex-basis-60%">
          ...
          <div className="viewbutton flex flex-col justify-center items-center w-full flex-grow-0 flex-shrink-0 flex-basis-20">
        ...
        <div className="text-gray-500 w-48 flex justify-center items-center">
          ...
          <div className="flex flex-col flex-grow-0 flex-shrink-0 flex-basis-60%">
            ...
            <p className="text-base font-normal my-1">
              The most influential entrepreneurship society at The University of
              Queensland.
            </p>
          </div>
          <div className="viewbutton flex flex-col justify-center items-center w-full flex-grow-0 flex-shrink-0 flex-basis-20">
